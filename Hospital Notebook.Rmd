...
ggplot(data = census_IA) +
  ...
  labs(title = "Iowa Median Family Income by County") + 
  theme_void()
#Cannot seem to get rid of grid lines! Tried all manor of panel.grid.etc, setting panel.grid = element_blank() works on other graphs....?
